 ...
 */
@Opcode("RETURN")
public final class AMD64HotSpotReturnOp extends AMD64HotSpotEpilogueBlockEndOp implements ZapStackArgumentSpaceBeforeInstruction, BytecodeLoopReturnOp {
    ...
    public void emitCode(CompilationResultBuilder crb, AMD64MacroAssembler masm) {
        ...
        if (!isStub) {
            if (requiresReservedStackAccessCheck) {
                ...
                AMD64Call.directJmp(crb, masm, foreignCalls.lookupForeignCall(HotSpotHostBackend.THROW_DELAYED_STACKOVERFLOW_ERROR), scratchForSafepointOnReturn);

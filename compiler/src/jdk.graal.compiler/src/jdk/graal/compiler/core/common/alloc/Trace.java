...
/**
 * Represents a list of sequentially executed {@code BasicBlock blocks}.
 */
public class Trace {
    ...
    public Trace(Collection<BasicBlock<?>> blocks) {
        this(blocks.toArray(new BasicBlock<?>[0]));
    }

    public Trace(BasicBlock<?>[] blocks) {
        this.blocks = blocks;

...
import jdk.graal.compiler.lir.alloc.trace.lsra.TraceInterval.State;
...
final class TraceLinearScanWalker {
    ...
    private BasicBlock<?> blockAt(int idx) {
        return allocator.blockAt(idx);
    }

    @SuppressWarnings("unused")
    private BasicBlock<?> blockOfOpWithId(int opId) {
    ...
    private int findOptimalSplitPos(BasicBlock<?> minBlock, BasicBlock<?> maxBlock, int maxSplitPos) {
    ...
    private int findOptimalSpillPos0(int minSpillPos, int maxSpillPos) {
        ...
        BasicBlock<?> minBlock = allocator.blockForId(minSpillPos);
        BasicBlock<?> maxBlock = allocator.blockForId(maxSpillPos);
    ...
    private int findOptimalSpillPos(BasicBlock<?> minBlock, BasicBlock<?> maxBlock, int maxSplitPos) {
        int fromBlockNr = minBlock.getLinearScanNumber();
        int toBlockNr = maxBlock.getLinearScanNumber();

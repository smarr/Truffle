...
import jdk.graal.compiler.lir.alloc.trace.TraceRegisterAllocationPolicy.AllocationStrategy;
import jdk.graal.compiler.lir.alloc.trace.bu.BottomUpAllocator;
...
public final class DefaultTraceRegisterAllocationPolicy {
    ...
    public abstract static class BottomUpLoopStrategyBase extends BottomUpStrategy {
        ...
        public final boolean shouldApplyTo(Trace trace) {
            ...
            if (getLIR().getControlFlowGraph().getNumberOfLoops() == 0) {
    ...
    public static final class BottomUpMaxFrequencyStrategy extends BottomUpStrategy {
        ...
        private static double maxRelativeFrequency(BasicBlock<?>[] blocks) {
            double max = 0;

...
import jdk.graal.compiler.lir.alloc.trace.lsra.TraceLinearScanPhase.IntervalPredicate;
...
final class TraceLinearScanEliminateSpillMovePhase extends TraceLinearScanAllocationPhase {
     ...
     *            no valid opId but -1.)
     */
    private static boolean canEliminateSpillMove(TraceLinearScan allocator, BasicBlock<?> block, MoveOp move, int lastOpId) {
